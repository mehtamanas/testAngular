ROEditCtrl = function ($scope, $state, $cookieStore, apiService, $modalInstance, $rootScope, $sanitize, $modal, emailData, FileUploader) {
    ...
    $scope.saveTemplate = function (isvalid) {
        if (isvalid) {
            ...
            var postdata = {
                ...
                project_id: $scope.params.projectSelected,
