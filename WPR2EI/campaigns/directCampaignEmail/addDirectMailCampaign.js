...
.controller('addDirectEmailCampaignController', function ($scope, $state, $cookieStore, apiService, $modal, $rootScope, $window) {
    console.log("addDirectEmailCampaignController");
