...
.controller('summaryMailTypeCtrl',
    function ($scope, $state, security, $cookieStore, apiService, $modal, $rootScope, $q, emailService, $localStorage) {
        ...
        //for (i = 0; i < $localStorage.contactDetails.length; i++)
        //{
           
        //    $scope.email = $localStorage.contactDetails[i].email;
        //    $scope.fname = $localStorage.contactDetails[i].first_name;
        //    $scope.lname = $localStorage.contactDetails[i].last_name;
        //}
