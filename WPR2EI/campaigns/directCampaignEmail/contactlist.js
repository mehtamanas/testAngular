...
function ($scope, $state, $cookieStore, apiService, $rootScope, $window, $q, emailService, $localStorage) {
    console.log('contactDirectEmailCampaignController');
    ...
    $scope.nextEmailType = function () {
        ...
        apiService.get(Url).then(function (response) {
            ...
            $localStorage.contactDetails = $scope.data1;
    ...
    $scope.backbudget = function () {

        $state.go('app.budgetDirectMailCampaign');
    }
});
