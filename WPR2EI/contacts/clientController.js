       ...
       function (error) {
        ...
        var callViewApi = function () {
            ...
            apiService.getWithoutCaching('Notes/GetByOrgid/' + $cookieStore.get('orgID')).then(function (res) {
                ...
                { return o.grid_name === 'client' && o.query_type === 'View' });
            }, function (err) {
        ...
        $scope.saveView = function () {
            ...
            var modalInstance = $modal.open({
                ...
                size: 'sm',
                resolve: { viewData: { sort: sortObject, col: grid.columns, grid: 'client', type: 'View', filterQuery: Querydata, filterObj: grid.dataSource._filter } }
            });
        }
        ...
        $scope.editView = function () {
            if ($scope.gridView !== 'default') {
                ...
                var modalInstance = $modal.open({
                    ...
                    size: 'sm',
                    resolve: { viewData: { sort: sortObject, col: grid.columns, grid: 'client', type: 'View', filterQuery: Querydata, filterObj: grid.dataSource._filter, viewName: viewName[0].view_name, viewId: $scope.gridView, isViewDefault: viewName[0].default_view } }
                });
            }
            else {
