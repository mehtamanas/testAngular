       ...
       function (error) {
        ...
        $scope.saveView = function () {
            ...
            var modalInstance = $modal.open({
                ...
                size: 'sm',
                resolve: { viewData: { sort: sortObject, col: grid.columns, grid: 'contact', type: 'View', filterQuery: Querydata, filterObj: grid.dataSource._filter } }
            });
        }
