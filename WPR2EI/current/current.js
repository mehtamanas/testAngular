       ...
       function (error) {
        ...
        $scope.mainGridOptions = {
            dataSource: {
                type: "json",
                transport: {
                 //   read: apiService.baseUrl +"ChannelPartners/GetListorgID/38a801a8-9c32-4b52-8433-00c059421218/Approved"
                    read: apiService.baseUrl +"ChannelPartners/GetListorgID/" + orgID + "/Approved"
                },
                pageSize: 5
