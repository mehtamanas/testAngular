...
.controller('SubscriptionListController',
       function ($scope, $state, security, $cookieStore, apiService, $modal, $http, $rootScope) {
          ...
          function (error) {
           ...
           projectUrl = "Subscription/GetSubscriptionGrid?id=dd3aaef9-33f1-4306-bf38-b8af7ff17578";
      ...
      function (error) {
          console.log("Error " + error.state);
           ...
           projectUrl = "Subscription/GetSubscriptionSummary?id=ba170687-5b57-4aa0-926c-f32b627909c6";

           // alert(param.name);
           apiService.get(projectUrl).then(function (response) {
               $scope.subscriptions1= response.data;
