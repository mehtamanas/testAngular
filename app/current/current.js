...
.controller('currentController',
    function ($scope, $state, security, $cookieStore, apiService, $modal, $rootScope) {
        ...
        $rootScope.title = 'Dwellar./current';
       ...
       function (error) {
        ...
        $scope.mainGridOptions = {
            dataSource: {
                type: "json",
                transport: {
                 //   read: "https://dw-webservices-dev.azurewebsites.net/ChannelPartners/GetListorgID/38a801a8-9c32-4b52-8433-00c059421218/Approved"
                    read: "https://dw-webservices-dev.azurewebsites.net/ChannelPartners/GetListorgID/" + orgID + "/Approved"
                },
                pageSize: 5
