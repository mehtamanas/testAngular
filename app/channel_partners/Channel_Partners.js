...
.controller('Channel_PartnersController',
      function ($scope, $state, security, apiService, $cookieStore, $rootScope) {
          ...
          $scope.params = {
              ...
              module_id: "Channel Partner",
              action_id: "Channel Partner View",
              details: "Channel Partner detail",
              application: "angular",
         ...
         function (error) {
          ...
          $scope.mainGridOptions = {
              dataSource: {
                  type: "json",
                  transport: {
                      read: "https://dw-webservices-dev.azurewebsites.net/ChannelPartners/GetByID/" + orgID

                      //read:"https://dw-webservices-dev.azurewebsites.net/ChannelPartners/GetByID/38a801a8-9c32-4b52-8433-00c059421218"
                  },
                  pageSize: 5
